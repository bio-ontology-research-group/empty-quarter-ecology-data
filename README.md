...
The ledger and fail-closed generator make four source issues explicit:
...
- 15 records appended to the legacy Trip 3 worksheet retain their original
  ...
  Trip 3 contains 60 primary and five named February 2024 records;
- the Trip 5 site 40 source humidity of 194% is preserved in the ledger but
  ...
  correction; and
- the Trip 1 and Trip 3 site 52 rows (and the appended `52AD` record) repeat
  the site 53 coordinates; the ledger restores the site 52 location recorded
  in Trips 4 and 5 (20.82784 N, 53.57835 E), which the Trip 3 GPS track and
  the route timing corroborate. The per-campaign geodata rows and their
  annual climate values for site 52 were re-derived at that point
