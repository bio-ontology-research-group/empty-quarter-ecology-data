...
ZrO2 & ZrO2 & -- & CID:62395 \\
\end{longtable}
\noindent\textit{Interpretation.} A dash denotes an audited null. These \texttt{rdfs:seeAlso} cross-references identify the element or oxide-equivalent reporting channel. The P$_2$O$_5$ channel is cross-referenced to the ChEBI P$_4$O$_{10}$ class only because the formulas share the P:O empirical ratio. LE is an instrument aggregate, and PrO$_2$ has no formula-matching external identifier in the audited sources.
