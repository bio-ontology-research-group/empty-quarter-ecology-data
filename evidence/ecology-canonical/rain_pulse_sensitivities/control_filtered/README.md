...
This run uses the control filtered sensitivity community table
and the nasa power rainfall product. Its analysis
units are technical replicates averaged within 617 site-campaign-position groups. The model
